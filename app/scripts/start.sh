...
echo "  初始化账号密码: 请查看 SEED_USER_PASSWORDS_JSON 或受控密码管理器"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "常用命令："
echo "  查看日志:    docker logs exam-backend"
echo "  停止服务:    docker compose --env-file .env -f docker/docker-compose.yml down"
echo "  重启服务:    docker compose --env-file .env -f docker/docker-compose.yml restart"
