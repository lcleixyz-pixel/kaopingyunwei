...
export const DEFAULT_PDF_TEMPLATES: Record<PdfTemplateKey, { name: string; version: number; definition: PdfTemplateDefinition }> = {
  ...
  CERTIFICATE_PRINT: {
    ...
    definition: {
      ...
      fields: [
        { id: 'name', type: 'text', label: '姓名', source: 'candidate.name', xMm: 192, yMm: 67.6, widthMm: 70, heightMm: 12, fontSize: 14, align: 'center' },
        { id: 'photo', type: 'image', label: '证件照', source: 'candidate.photo', xMm: 35, yMm: 60, widthMm: 25, heightMm: 35, fontSize: 10, align: 'center' },
        { id: 'idType', type: 'text', label: '证件类型', source: 'idTypeLabel', xMm: 192, yMm: 80.4, widthMm: 70, heightMm: 12, fontSize: 14, align: 'center' },
        { id: 'idCard', type: 'text', label: '证件号码', source: 'candidate.idCard', xMm: 192, yMm: 94, widthMm: 70, heightMm: 12, fontSize: 14, align: 'center' },
        { id: 'occupation', type: 'text', label: '职业', source: 'candidate.plan.occupation', xMm: 192, yMm: 106.6, widthMm: 70, heightMm: 12, fontSize: 14, align: 'center' },
        { id: 'profession', type: 'text', label: '工种', source: 'candidate.plan.profession', xMm: 192, yMm: 119.6, widthMm: 70, heightMm: 12, fontSize: 14, align: 'center' },
        { id: 'level', type: 'text', label: '等级', source: 'candidate.plan.level', xMm: 192, yMm: 133, widthMm: 70, heightMm: 12, fontSize: 14, align: 'center' },
        { id: 'certNo', type: 'text', label: '证书编号', source: 'certNo', xMm: 192, yMm: 146.4, widthMm: 70, heightMm: 12, fontSize: 14, align: 'center' },
        { id: 'date', type: 'text', label: '发证日期', source: 'certDisplayIssueDate', xMm: 206.3, yMm: 171.5, widthMm: 40.4, heightMm: 8.1, fontSize: 12, align: 'center' },
      ],
    },
  },
  CERT_DESTROY_BATCH: {
